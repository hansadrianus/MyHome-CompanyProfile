        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="well-middle">
                    <div class="single-well">
                        <a href="#">
                            <h4 class="sec-head">TENTANG KAMI</h4>
                        </a>
                        <p>
                        <b>GRAHA SOLUSI INDONUSA</b> adalah Kontraktor  interior yang secara khusus menangani proyek-proyek interior typical seperti interior hotel, apartment, rumah sakit atau bangunan jenis lainnya.
